...
public class SparkCodeGenerator implements IRNodeVisitor<Column> {
    ...
    public Column visitGetValue(@Nonnull GetValue getValue) {
        Column child = getValue.child().accept(this);
...
- [ ] Resolve all open questions (section 9.1)
- [ ] Create feature branch: `feature/option-4-hybrid-design`
- [ ] Set up CI/CD for feature branch
- [ ] Create migration tracking board (Jira/GitHub issues)

### Phase 1: Signature Storage
- [ ] Add signature field to all operation classes
- [ ] Update IRNodeBuilder interface
- [ ] Update IRClassBuilder implementation
- [ ] Update FunctionRegistry.doResolve()
- [ ] Run full test suite
- [ ] Code review
...
- [ ] Move all signature definitions to registry
- [ ] Update FunctionRegistry to query registry
- [ ] Remove SIGNATURES from operation classes
...
- [ ] Create IRNodeVisitor interface
- [ ] Create SparkCodeGenerator class
- [ ] Add accept() to IRNode interface
- [ ] Implement accept() in all node classes
- [ ] Delegate eval() to SparkCodeGenerator
...
### Phase 4: Consolidate to Operation
- [ ] Create Operation class
- [ ] Update FunctionRegistry to create Operations
- [ ] Update SparkCodeGenerator.visitOperation()
- [ ] Update IRNodeVisitor interface
- [ ] Delete old operation classes
- [ ] Update all tests to use Operation
- [ ] Run full test suite
- [ ] Integration tests
- [ ] Performance benchmark
- [ ] Code review
