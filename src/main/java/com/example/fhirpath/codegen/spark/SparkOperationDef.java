 ...
 *
 * <p>Each operation is a pure function that takes evaluated argument columns,
 * the original IR nodes (for metadata like type/cardinality), the result type,
 * and a reference to the code generator (for operations like where/iif that
 * need to evaluate lambda bodies).
 */
@FunctionalInterface
