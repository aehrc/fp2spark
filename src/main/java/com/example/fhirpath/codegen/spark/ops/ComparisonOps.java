...
public final class ComparisonOps {
    ...
    public static void register(SparkOperationRegistry registry) {
        registry.register("gt", (args, nodes, type, gen) ->
        ...
        registry.register("lt", (args, nodes, type, gen) ->
                switch ((PrimitiveType) nodes.get(0).getType()) {
        ...
        registry.register("geq", (args, nodes, type, gen) ->
                switch ((PrimitiveType) nodes.get(0).getType()) {
        ...
        registry.register("leq", (args, nodes, type, gen) ->
                switch ((PrimitiveType) nodes.get(0).getType()) {
