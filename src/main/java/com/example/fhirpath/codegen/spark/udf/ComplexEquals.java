 ...
 *
 * <p>Used by {@link com.example.fhirpath.codegen.spark.ops.EqualityOps} as the comparator for FHIR
 * complex types (HumanName, Address, Period, Identifier, etc.). Pure structural — does not defer to
 * {@code QuantitySupport}, {@code CodingSupport} or {@code TemporalSupport} for sub-fields.
 */
