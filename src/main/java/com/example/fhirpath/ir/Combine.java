...
/**
 * Represents a combine operation (;) in FHIRPath - ordered concatenation. Result is always MANY
 * cardinality (0..*).
 *
 * <p>Note: This is distinct from union (|) which has undefined order per FHIRPath spec. The combine
 * operator preserves left-to-right ordering.
 *
