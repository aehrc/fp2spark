 ...
 *
 * <p>Different visitor implementations enable different target backends:
 *
 * <ul>
 *   <li>SparkCodeGenerator: Generates Spark Column expressions
 *   <li>SqlServerCodeGenerator: Generates SQL Server T-SQL strings
 *   <li>PostgreSqlCodeGenerator: Generates PostgreSQL SQL strings
 *   <li>DebugVisitor: Generates human-readable string representation
 *   <li>ValidationVisitor: Validates IR tree correctness
 * </ul>
 *
...
public interface IRNodeVisitor<T> {
  ...
  /**
   * Visit a $this reference in lambda expressions. $this is substituted with the actual element
   * during lambda inlining.
   */
  @Nonnull
