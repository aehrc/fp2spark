 ...
 *
 * <p>The lambda body can reference special variables like $this (current element) and $index (position).
...
public record Lambda(
    ...
    /**
     * Returns the shape of the lambda body (what it evaluates to).
