...
/**
 * Handles special infrastructure operations that don't follow the standard signature-based
 * resolution pattern.
 *
 * <p>These operations are handled separately because they:
 *
 * <ul>
 *   <li>Don't require overload resolution (single implementation)
 *   <li>Directly construct specific IR node types
 *   <li>Have special semantics not captured by standard signatures
 * </ul>
 *
...
public final class InfrastructureOperationHandler {
  ...
  /**
   * Handles infrastructure operations by analyzing arguments and constructing appropriate IR nodes.
   *
