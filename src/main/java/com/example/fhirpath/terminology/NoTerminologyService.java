 ...
 * specification maps to an empty result. This is deliberately silent rather than an error, so that
 * expressions containing {@code memberOf()} still compile and evaluate without a terminology
 * server.
 *
 ...
 * elements on an unconfigured build rather than failing loudly. Supply a {@link
