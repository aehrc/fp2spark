 ...
 * </ul>
 *
 * <p>These tests verify that expressions like {@code (1 ; 2) + 2} are rejected at analysis time
 * with {@link CardinalityMismatchException}.
 */
public class CardinalityErrorsTest extends FhirPathTestBase {
  ...
  Stream<DynamicTest> testMathOperatorsLeftOperandMany() {
    return builder()
        ...
        .testError(
            CardinalityMismatchException.class, "(1 ; 2) + 2", "Addition with MANY left operand")
        .testError(
            CardinalityMismatchException.class, "(1 ; 2) - 3", "Subtraction with MANY left operand")
        .testError(
            CardinalityMismatchException.class,
            "(1 ; 2) * 3",
            "Multiplication with MANY left operand")
        .testError(
            CardinalityMismatchException.class, "(5 ; 10) / 2", "Division with MANY left operand")
        .testError(
            CardinalityMismatchException.class,
            "(1 ; 2 ; 3) mod 2",
            "Modulo with MANY left operand")
        .build();
  }
  ...
  Stream<DynamicTest> testMathOperatorsRightOperandMany() {
    return builder()
        ...
        .testError(
            CardinalityMismatchException.class, "2 + (1 ; 2)", "Addition with MANY right operand")
        .testError(
            CardinalityMismatchException.class,
            "10 - (1 ; 2)",
            "Subtraction with MANY right operand")
        .testError(
            CardinalityMismatchException.class,
            "5 * (2 ; 3)",
            "Multiplication with MANY right operand")
        .testError(
            CardinalityMismatchException.class, "10 / (2 ; 5)", "Division with MANY right operand")
        .testError(
            CardinalityMismatchException.class, "10 mod (2 ; 3)", "Modulo with MANY right operand")
        .build();
  }
  ...
  Stream<DynamicTest> testMathOperatorsBothOperandsMany() {
    return builder()
        ...
        .testError(
            CardinalityMismatchException.class, "(1 ; 2) + (3 ; 4)", "Addition with both MANY")
        .testError(
            CardinalityMismatchException.class, "(1 ; 2) - (3 ; 4)", "Subtraction with both MANY")
        .testError(
            CardinalityMismatchException.class,
            "(1 ; 2) * (3 ; 4)",
            "Multiplication with both MANY")
        .testError(
            CardinalityMismatchException.class, "(10 ; 20) / (2 ; 5)", "Division with both MANY")
        .build();
  }
  ...
  Stream<DynamicTest> testComparisonOperatorsLeftOperandMany() {
    return builder()
        ...
        .testError(
            CardinalityMismatchException.class,
            "(1 ; 2) > 5",
            "Greater than with MANY left operand")
        .testError(
            CardinalityMismatchException.class, "(1 ; 2) < 5", "Less than with MANY left operand")
        .testError(
            CardinalityMismatchException.class,
            "(1 ; 2) >= 5",
            "Greater or equal with MANY left operand")
        .testError(
            CardinalityMismatchException.class,
            "(1 ; 2) <= 5",
            "Less or equal with MANY left operand")
        .build();
  }
  ...
  Stream<DynamicTest> testComparisonOperatorsRightOperandMany() {
    return builder()
        ...
        .testError(
            CardinalityMismatchException.class,
            "5 > (1 ; 2)",
            "Greater than with MANY right operand")
        .testError(
            CardinalityMismatchException.class, "5 < (1 ; 2)", "Less than with MANY right operand")
        .testError(
            CardinalityMismatchException.class,
            "5 >= (1 ; 2)",
            "Greater or equal with MANY right operand")
        .testError(
            CardinalityMismatchException.class,
            "5 <= (1 ; 2)",
            "Less or equal with MANY right operand")
        .build();
  }
  ...
  Stream<DynamicTest> testComparisonOperatorsBothOperandsMany() {
    return builder()
        ...
        .testError(
            CardinalityMismatchException.class, "(1 ; 2) > (3 ; 4)", "Greater than with both MANY")
        .testError(
            CardinalityMismatchException.class, "(1 ; 2) < (3 ; 4)", "Less than with both MANY")
        .testError(
            CardinalityMismatchException.class,
            "(1 ; 2) >= (3 ; 4)",
            "Greater or equal with both MANY")
        .testError(
            CardinalityMismatchException.class,
            "(1 ; 2) <= (3 ; 4)",
            "Less or equal with both MANY")
        .build();
  }
  ...
  Stream<DynamicTest> testStringOperationsWithMany() {
    return builder()
        ...
        .testError(
            CardinalityMismatchException.class, "('a' ; 'b') + 'c'", "String concat with MANY left")
        .testError(
            CardinalityMismatchException.class,
            "'prefix' + ('a' ; 'b')",
            "String concat with MANY right")
        .testError(
            CardinalityMismatchException.class,
            "('hello' ; 'world') + ('foo' ; 'bar')",
            "String concat with both MANY")
        .build();
  }
  ...
  Stream<DynamicTest> testNestedConcatenations() {
    return builder()
        ...
        .testError(
            CardinalityMismatchException.class,
            "((1 ; 2) ; 3) + 4",
            "Nested concatenation left + single")
        .testError(
            CardinalityMismatchException.class,
            "(1 ; (2 ; 3)) > 0",
            "Nested concatenation comparison")
        .build();
  }
  ...
  Stream<DynamicTest> testValidCardinalityUsages() {
    return builder()
        ...
        .testEquals(
            java.util.List.of(2, 3), "(1 ; 2 ; 3).where($this > 1)", "where() on collection")
