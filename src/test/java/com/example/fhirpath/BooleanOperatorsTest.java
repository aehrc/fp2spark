 ...
 *
 * <p>Tests all boolean operators with three-valued logic as specified in the FHIRPath
 * specification.
 *
 * <p>Based on FHIRPath spec section 6.5: Boolean logic
 *
 * <p>Covers: - All spec truth tables for and, or, not, xor, implies - Three-valued logic (true,
 * false, empty) - Edge cases with empty collections
 */
