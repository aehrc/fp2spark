 ...
 * <p>
 * These tests verify that expressions can reference the %context variable
 * and that functions like count() and exists() use context as implicit target
 * when no explicit target is provided.
 * <p>
 * Ported from {@code FhirPathIntegrationTest#testFhirPathExpressionsWithContext}.
 */
public class ContextExpressionsTest extends FhirPathTestBase {
    ...
    Stream<DynamicTest> testComplexContextExpressions() {
        return builder()
                ...
                .testTrue("count() = 3", context("10 ; 20 ; 30 ; %context.foo"),
