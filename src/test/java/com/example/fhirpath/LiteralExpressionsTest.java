 ...
 * <ul>
 *   <li>Literal values (strings, numbers, booleans, empty collections)</li>
 *   <li>Arithmetic operators (+, -, /, *)</li>
 *   <li>Comparison operators (&lt;, &gt;, &lt;=, &gt;=)</li>
 *   <li>Equality operators (=, !=)</li>
 *   <li>Collection operators (; for concatenation)</li>
 *   <li>Functions (count(), exists(), where(), iif(), first())</li>
 * </ul>
 *
 * <p>These tests are ported from the original parameterized test in FhirPathIntegrationTest
 * to use the new fluent DSL for better readability and organization.
 */
public class LiteralExpressionsTest extends FhirPathTestBase {
    ...
    Stream<DynamicTest> testConcatenation() {
        return builder()
                ...
                .testEquals(List.of(2, 3, 1.1, 2.3, 2.0), "(2 ; 3) ; (1.1 ; 2.3 ; 2.0)",
    ...
    Stream<DynamicTest> testIif() {
        return builder()
                ...
                .testEquals(List.of(3, 4), "(1 ; 2 ; 3 ; 4).iif(count() > 2, where($this > 2))",
