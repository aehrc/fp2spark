...
public class TypeConversionTest extends FhirPathTestBase {
  ...
  Stream<DynamicTest> testToQuantity() {
    return builder()
        ...
        .group("toQuantity - from String")
        .testTrue("'42'.toQuantity() = 42 '1'", "Numeric string → default unit")
        .testTrue("'3.14'.toQuantity() = 3.14 '1'", "Decimal string → default unit")
        .testTrue("'10 days'.toQuantity() = 10 day", "String with calendar unit")
        .testTrue("'4 days'.toQuantity() = 4 day", "Plural calendar unit normalized")
        .testEmpty("'not-a-quantity'.toQuantity()", "Invalid string → empty")
        .group("toQuantity - from Boolean")
        .testTrue("true.toQuantity() = 1.0 '1'", "true → 1.0 '1'")
        .testTrue("false.toQuantity() = 0.0 '1'", "false → 0.0 '1'")
        .group("toQuantity - non-convertible types")
        .testEmpty("@2023-06-15.toQuantity()", "Date → empty")
