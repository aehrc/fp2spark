 ...
 *
 * <p>Tests all literal types and escape sequences as specified in the FHIRPath specification.
 * Does NOT assume existence of any operations except basic field traversal.
 *
...
public class TypesAndLiteralsTest extends FhirPathTestBase {
    ...
    Stream<DynamicTest> testEmptyCollectionLiteral() {
        return builder()
                .group("Empty collection literal")
                .testEmpty("{}", "Empty collection")
                .build();
    }
    ...
    Stream<DynamicTest> testNestedFieldTraversal() {
        return builder()
                ...
                .withSubject("Patient", p -> p
                        ...
                        .element("address", a -> a
                                .string("city", "Boston")
                                .element("location", l -> l
                                        .decimal("latitude", 42.3601)
    ...
    Stream<DynamicTest> testArrayFieldsAllTypes() {
        return builder()
                ...
                .withSubject("Patient", p -> p
                        .stringArray("identifier", "id1", "id2", "id3")
                )
                .testEquals(List.of("id1", "id2", "id3"), "identifier")
                .group("Array fields - Integer")
                .withSubject("Observation", o -> o
                        .integerArray("values", 10, 20, 30)
                )
                .testEquals(List.of(10, 20, 30), "values")
                .group("Array fields - Decimal")
                .withSubject("Measurement", m -> m
                        .decimalArray("readings", 1.1, 2.2, 3.3)
                )
                .testEquals(List.of(1.1, 2.2, 3.3), "readings")
                .group("Array fields - Boolean")
                .withSubject("Flags", f -> f
                        .boolArray("flags", true, false, true)
                )
    ...
    Stream<DynamicTest> testNestedArrayFields() {
        return builder()
                ...
                .testEquals(List.of(2101, 2139), "contact.address.zip",
                        "Array with deep nesting - integers")
                .build();
    }
    ...
    Stream<DynamicTest> testMixedCardinalityFields() {
        return builder()
                ...
                .withSubject("Patient", p -> p
                        ...
                        .element("address", a -> a             // SINGLE complex
                                .string("city", "Boston")
                                .stringArray("lines", "123 Main", "Apt 4")  // MANY in nested
                        )
                        .elementArray("contact",               // MANY complex
