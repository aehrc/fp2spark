 ...
 *
 * <p>Provides type-specific methods for building JSON-like data structures
 * used in FHIRPath resource tests. The builder creates a {@code Map<String, Object>}
 * where values can be primitives, Lists, or nested Maps.
 *
 * <p><b>Usage example:</b>
 * <pre>{@code
...
public class ResourceDataBuilder {
     ...
     */
    @Nonnull
    public ResourceDataBuilder stringArray(@Nonnull final String name, @Nonnull final String... values) {
     ...
     */
    @Nonnull
    public ResourceDataBuilder integerArray(@Nonnull final String name, @Nonnull final Integer... values) {
        data.put(name, List.of(values));
        return this;
    }
     ...
     */
    @Nonnull
    public ResourceDataBuilder decimalArray(@Nonnull final String name, @Nonnull final Double... values) {
        data.put(name, List.of(values));
        return this;
    }
     ...
     */
    @Nonnull
    public ResourceDataBuilder boolArray(@Nonnull final String name, @Nonnull final Boolean... values) {
        data.put(name, List.of(values));
        return this;
    }
    ...
    public ResourceDataBuilder element(
            ...
            @Nonnull final Consumer<ResourceDataBuilder> builderConsumer
    ) {
    ...
    public final ResourceDataBuilder elementArray(
            @Nonnull final String name,
            @Nonnull final Consumer<ResourceDataBuilder>... builders
    ) {
